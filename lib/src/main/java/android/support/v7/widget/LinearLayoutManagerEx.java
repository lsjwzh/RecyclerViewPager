...
/**
 * A {@link android.support.v7.widget.RecyclerViewEx.LayoutManager} implementation which provides
 * similar functionality to {@link android.widget.ListView}.
 */
public class LinearLayoutManagerEx extends RecyclerViewEx.LayoutManager {
     ...
     * {@link #onLayoutChildren(RecyclerViewEx.Recycler, RecyclerViewEx.State)} is run.
     */
    ...
    * */
    ...
    /**
     * Sets the orientation of the layout. {@link LinearLayoutManagerEx}
     ...
     * When set to true, If {@link android.support.v7.widget.RecyclerViewEx} is LTR, than it will
     * layout from RTL, if {@link android.support.v7.widget.RecyclerViewEx}} is RTL, it will layout
     * from LTR.
     *
    ...
    void ensureLayoutState() {
        ...
        if (mOrientationHelper == null) {
            mOrientationHelper = OrientationHelperEx.createOrientationHelper(this, mOrientation);
        }
    }
