...
import static android.support.v7.widget.RecyclerViewEx.ViewHolder;
 ...
 */
class AdapterHelperEx implements OpReordererEx.Callback {
    ...
    final OpReordererEx mOpReorderer;

    AdapterHelperEx(Callback callback) {
        this(callback, false);
    }

    AdapterHelperEx(Callback callback, boolean disableRecycler) {
        mCallback = callback;
        mDisableRecycler = disableRecycler;
        mOpReorderer = new OpReordererEx(this);
    }

    AdapterHelperEx addUpdateOp(UpdateOp... ops) {
