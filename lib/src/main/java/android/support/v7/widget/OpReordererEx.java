...
import android.support.v7.widget.AdapterHelperEx.UpdateOp;

import java.util.List;

import static android.support.v7.widget.AdapterHelperEx.UpdateOp.ADD;
import static android.support.v7.widget.AdapterHelperEx.UpdateOp.MOVE;
import static android.support.v7.widget.AdapterHelperEx.UpdateOp.REMOVE;
import static android.support.v7.widget.AdapterHelperEx.UpdateOp.UPDATE;

class OpReordererEx {

    final Callback mCallback;

    public OpReordererEx(Callback callback) {
        mCallback = callback;
    }
