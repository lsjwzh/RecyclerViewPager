...
class ChildHelperEx {
    ...
    ChildHelperEx(Callback callback) {
        mCallback = callback;
        mBucket = new Bucket();
    ...
    View findHiddenNonRemovedView(int position, int type) {
        ...
        for (int i = 0; i < count; i++) {
            ...
            RecyclerViewEx.ViewHolder holder = mCallback.getChildViewHolder(view);
    ...
    static interface Callback {
        ...
        RecyclerViewEx.ViewHolder getChildViewHolder(View view);
