 ...
 *
 * <ul>
 *     <li><em>Adapter:</em> A subclass of {@link android.support.v7.widget.RecyclerViewEx.Adapter} responsible for providing views
 ...
 *     from the parent RecyclerViewEx, either unmodified if no rebinding is required or modified
 ...
 * </ul>
 */
public class RecyclerViewEx extends ViewGroup {
     ...
     * that the RecyclerViewEx should use the standard touch slop for smooth,
    ...
    /**
     * Constant for use with {@link #setScrollingTouchSlop(int)}. Indicates
     * that the RecyclerViewEx should use the standard touch slop for scrolling
    ...
    AdapterHelperEx mAdapterHelper;

    ChildHelperEx mChildHelper;
    ...
    ItemAnimator mItemAnimator = new DefaultItemAnimatorEx();

    private static final int INVALID_POINTER = -1;

    /**
     * The RecyclerViewEx is not currently scrolling.
     * @see #getScrollState()
     */
    public static final int SCROLL_STATE_IDLE = 0;

    /**
     * The RecyclerViewEx is currently being dragged by outside input such as user touch input.
     * @see #getScrollState()
     */
    public static final int SCROLL_STATE_DRAGGING = 1;

    /**
     * The RecyclerViewEx is currently animating to a final position while not under
     * outside control.
     * @see #getScrollState()
     */
    ...
    private RecyclerViewAccessibilityDelegateEx mAccessibilityDelegate;
    ...
    /**
     * Returns the accessibility delegate compatibility implementation used by the RecyclerViewEx.
     * @return An instance of AccessibilityDelegateCompat used by RecyclerViewEx
     */
    public RecyclerViewAccessibilityDelegateEx getCompatAccessibilityDelegate() {
        return mAccessibilityDelegate;
    }

    /**
     * Sets the accessibility delegate compatibility implementation used by RecyclerViewEx.
     * @param accessibilityDelegate The accessibility delegate to be used by RecyclerViewEx.
     */
    public void setAccessibilityDelegateCompat(
            RecyclerViewAccessibilityDelegateEx accessibilityDelegate) {
        mAccessibilityDelegate = accessibilityDelegate;
        ViewCompat.setAccessibilityDelegate(this, mAccessibilityDelegate);
    }

    private void initChildrenHelper() {
        mChildHelper = new ChildHelperEx(new ChildHelperEx.Callback() {
            @Override
            public int getChildCount() {
                return RecyclerViewEx.this.getChildCount();
            }

            @Override
            public void addView(View child, int index) {
                RecyclerViewEx.this.addView(child, index);
                dispatchChildAttached(child);
            }

            @Override
            public int indexOfChild(View view) {
                return RecyclerViewEx.this.indexOfChild(view);
            }

            @Override
            public void removeViewAt(int index) {
                final View child = RecyclerViewEx.this.getChildAt(index);
                if (child != null) {
                    dispatchChildDetached(child);
                }
                RecyclerViewEx.this.removeViewAt(index);
            }

            @Override
            public View getChildAt(int offset) {
                return RecyclerViewEx.this.getChildAt(offset);
            }
            ...
            public void removeAllViews() {
                ...
                RecyclerViewEx.this.removeAllViews();
            }
            ...
            public void attachViewToParent(View child, int index,
                ...
                RecyclerViewEx.this.attachViewToParent(child, index, layoutParams);
            }
            ...
            public void detachViewFromParent(int offset) {
                ...
                RecyclerViewEx.this.detachViewFromParent(offset);
            }
        });
    }

    void initAdapterManager() {
        mAdapterHelper = new AdapterHelperEx(new Callback() {
            @Override
            ...
            void dispatchUpdate(UpdateOp op) {
                switch (op.cmd) {
                    case UpdateOp.ADD:
                        mLayout.onItemsAdded(RecyclerViewEx.this, op.positionStart, op.itemCount);
                        break;
                    case UpdateOp.REMOVE:
                        mLayout.onItemsRemoved(RecyclerViewEx.this, op.positionStart, op.itemCount);
                        break;
                    case UpdateOp.UPDATE:
                        mLayout.onItemsUpdated(RecyclerViewEx.this, op.positionStart, op.itemCount);
                        break;
                    case UpdateOp.MOVE:
                        mLayout.onItemsMoved(RecyclerViewEx.this, op.positionStart, op.itemCount, 1);
                        break;
                }
            }
    ...
    /**
     * RecyclerViewEx can perform several optimizations if it can know in advance that changes in
     * adapter content cannot change the size of the RecyclerViewEx itself.
     * If your use of RecyclerViewEx falls into this category, set this to true.
     *
     * @param hasFixedSize true if adapter changes cannot affect the size of the RecyclerViewEx.
     */
     ...
     * the size of the RecyclerViewEx itself.
     */
     ...
     *
     * Set up the RecyclerViewEx's scrolling motion threshold based on common usages.
     ...
     *                     the intended usage of this RecyclerViewEx
     */
     ...
     * {@link #setAdapter(android.support.v7.widget.RecyclerViewEx.Adapter)} but assumes existing adapter and the new adapter uses the same
     * {@link android.support.v7.widget.RecyclerViewEx.ViewHolder} and does not clear the RecycledViewPool.
     * <p>
     * Note that it still calls onAdapterChanged callbacks.
     *
     * @param adapter The new adapter to set, or null to set no adapter.
     * @param removeAndRecycleExistingViews If set to true, RecyclerViewEx will recycle all existing
     *                                      Views. If adapters have stable ids and/or you want to
     *                                      animate the disappearing views, you may prefer to set
     *                                      this to false.
     * @see #setAdapter(android.support.v7.widget.RecyclerViewEx.Adapter)
     */
     ...
     *
     * @param adapter The new adapter to set, or null to set no adapter.
     * @see #swapAdapter(android.support.v7.widget.RecyclerViewEx.Adapter, boolean)
     */
     ...
     *
     * <p>This listener will be called when a LayoutManager or the RecyclerViewEx decides
    ...
    /**
     * Set the {@link android.support.v7.widget.RecyclerViewEx.LayoutManager} that this RecyclerViewEx will use.
     *
     * <p>In contrast to other adapter-backed views such as {@link android.widget.ListView}
     * or {@link android.widget.GridView}, RecyclerViewEx allows client code to provide custom
     * layout arrangements for child views. These arrangements are controlled by the
     * {@link android.support.v7.widget.RecyclerViewEx.LayoutManager}. A LayoutManager must be provided for RecyclerViewEx to function.</p>
     *
        ...
        if (layout != null) {
            if (layout.mRecyclerView != null) {
                throw new IllegalArgumentException("LayoutManager " + layout +
                        " is already attached to a RecyclerViewEx: " + layout.mRecyclerView);
            }
     ...
     * @see #addAnimatingView(android.support.v7.widget.RecyclerViewEx.ViewHolder)
    ...
    /**
     * Return the {@link android.support.v7.widget.RecyclerViewEx.LayoutManager} currently responsible for
     * layout policy for this RecyclerViewEx.
     *
    ...
    /**
     * Retrieve this RecyclerViewEx's {@link android.support.v7.widget.RecyclerViewEx.RecycledViewPool}. This method will never return null;
     * if no pool is set for this view a new one will be created. See
     * {@link #setRecycledViewPool(android.support.v7.widget.RecyclerViewEx.RecycledViewPool) setRecycledViewPool} for more information.
     *
     * @return The pool used to store recycled item views for reuse.
     * @see #setRecycledViewPool(android.support.v7.widget.RecyclerViewEx.RecycledViewPool)
     */
    ...
    /**
     * Sets a new {@link android.support.v7.widget.RecyclerViewEx.ViewCacheExtension} to be used by the Recycler.
     *
     * @param extension ViewCacheExtension to be used or null if you want to clear the existing one.
     *
     * @see {@link android.support.v7.widget.RecyclerViewEx.ViewCacheExtension#getViewForPositionAndType(android.support.v7.widget.RecyclerViewEx.Recycler, int, int)}
     */
    ...
    /**
     * Return the current scrolling state of the RecyclerViewEx.
     *
    ...
    /**
     * Add an {@link android.support.v7.widget.RecyclerViewEx.ItemDecoration} to this RecyclerViewEx. Item decorations can
     ...
     *
     * RecyclerViewEx does not implement scrolling logic, rather forwards the call to
     * {@link android.support.v7.widget.RecyclerViewEx.LayoutManager#scrollToPosition(int)}
     * @param position Scroll to this adapter position
     * @see android.support.v7.widget.RecyclerViewEx.LayoutManager#scrollToPosition(int)
     */
     ...
     * {@link android.support.v7.widget.RecyclerViewEx.LayoutManager#smoothScrollToPosition(RecyclerViewEx, android.support.v7.widget.RecyclerViewEx.State, int)} and create a
     * {@link android.support.v7.widget.RecyclerViewEx.SmoothScroller}.
     * <p>
     * {@link android.support.v7.widget.RecyclerViewEx.LayoutManager} is responsible for creating the actual scroll action. If you want to
     * provide a custom smooth scroll logic, override
     * {@link android.support.v7.widget.RecyclerViewEx.LayoutManager#smoothScrollToPosition(RecyclerViewEx, android.support.v7.widget.RecyclerViewEx.State, int)} in your
     * LayoutManager.
     *
     * @param position The adapter position to scroll to
     * @see android.support.v7.widget.RecyclerViewEx.LayoutManager#smoothScrollToPosition(RecyclerViewEx, android.support.v7.widget.RecyclerViewEx.State, int)
     */
    ...
    public void scrollTo(int x, int y) {
        throw new UnsupportedOperationException(
                "RecyclerViewEx does not support scrolling to an absolute position.");
    }
     ...
     * {@link android.support.v7.widget.RecyclerViewEx.LayoutManager#computeHorizontalScrollOffset(android.support.v7.widget.RecyclerViewEx.State)} in your
     * LayoutManager. </p>
     *
     * @return The horizontal offset of the scrollbar's thumb
     * @see android.support.v7.widget.RecyclerViewEx.LayoutManager#computeHorizontalScrollOffset
     * (RecyclerViewEx.Adapter)
     */
    @Override
     ...
     *
     * <p>If you want to support scroll bars, override
     * {@link android.support.v7.widget.RecyclerViewEx.LayoutManager#computeHorizontalScrollExtent(android.support.v7.widget.RecyclerViewEx.State)} in your
     * LayoutManager.</p>
     *
     * @return The horizontal extent of the scrollbar's thumb
     * @see android.support.v7.widget.RecyclerViewEx.LayoutManager#computeHorizontalScrollExtent(android.support.v7.widget.RecyclerViewEx.State)
     */
    @Override
     ...
     *
     * <p>If you want to support scroll bars, override
     * {@link android.support.v7.widget.RecyclerViewEx.LayoutManager#computeHorizontalScrollRange(android.support.v7.widget.RecyclerViewEx.State)} in your
     * LayoutManager.</p>
     *
     * @return The total horizontal range represented by the vertical scrollbar
     * @see android.support.v7.widget.RecyclerViewEx.LayoutManager#computeHorizontalScrollRange(android.support.v7.widget.RecyclerViewEx.State)
     */
    @Override
     ...
     *
     * <p>If you want to support scroll bars, override
     * {@link android.support.v7.widget.RecyclerViewEx.LayoutManager#computeVerticalScrollOffset(android.support.v7.widget.RecyclerViewEx.State)} in your
     * LayoutManager.</p>
     *
     * @return The vertical offset of the scrollbar's thumb
     * @see android.support.v7.widget.RecyclerViewEx.LayoutManager#computeVerticalScrollOffset
     * (RecyclerViewEx.Adapter)
     */
    @Override
     ...
     *
     * <p>If you want to support scroll bars, override
     * {@link android.support.v7.widget.RecyclerViewEx.LayoutManager#computeVerticalScrollExtent(android.support.v7.widget.RecyclerViewEx.State)} in your
     * LayoutManager.</p>
     *
     * @return The vertical extent of the scrollbar's thumb
     * @see android.support.v7.widget.RecyclerViewEx.LayoutManager#computeVerticalScrollExtent(android.support.v7.widget.RecyclerViewEx.State)
     */
    @Override
     ...
     *
     * <p>If you want to support scroll bars, override
     * {@link android.support.v7.widget.RecyclerViewEx.LayoutManager#computeVerticalScrollRange(android.support.v7.widget.RecyclerViewEx.State)} in your
     * LayoutManager.</p>
     *
     * @return The total vertical range represented by the vertical scrollbar
     * @see android.support.v7.widget.RecyclerViewEx.LayoutManager#computeVerticalScrollRange(android.support.v7.widget.RecyclerViewEx.State)
     */
    @Override
    ...
    /**
     * Checks if RecyclerViewEx is in the middle of a layout or scroll and throws an
    ...
    void assertInLayoutOrScroll(String message) {
        if (!mRunningLayoutOrScroll) {
            if (message == null) {
                throw new IllegalStateException("Cannot call this method unless RecyclerViewEx is "
    ...
    void assertNotInLayoutOrScroll(String message) {
        if (mRunningLayoutOrScroll) {
            if (message == null) {
                throw new IllegalStateException("Cannot call this method while RecyclerViewEx is "
                        + "computing a layout or scrolling");
            }
            throw new IllegalStateException(message);
        }
    ...
    /**
     * Add an {@link android.support.v7.widget.RecyclerViewEx.OnItemTouchListener} to intercept touch events before they are dispatched
     * to child views or this view's standard scrolling behavior.
     *
     * <p>Client code may use listeners to implement item manipulation behavior. Once a listener
     * returns true from
     * {@link android.support.v7.widget.RecyclerViewEx.OnItemTouchListener#onInterceptTouchEvent(RecyclerViewEx, android.view.MotionEvent)} its
     * {@link android.support.v7.widget.RecyclerViewEx.OnItemTouchListener#onTouchEvent(RecyclerViewEx, android.view.MotionEvent)} method will be called
    ...
    /**
     * Remove an {@link android.support.v7.widget.RecyclerViewEx.OnItemTouchListener}. It will no longer be able to intercept touch events.
     *
    ...
    /**
     * Sets the {@link android.support.v7.widget.RecyclerViewEx.ItemAnimator} that will handle animations involving changes
     * to the items in this RecyclerViewEx. By default, RecyclerViewEx instantiates and
     * uses an instance of {@link android.support.v7.widget.DefaultItemAnimator}. Whether item animations are
     * enabled for the RecyclerViewEx depends on the ItemAnimator and whether
     * the LayoutManager {@link android.support.v7.widget.RecyclerViewEx.LayoutManager#supportsPredictiveItemAnimations()
     * supports item animations}.
     *
     * @param animator The ItemAnimator being set. If null, no animations will occur
     * when changes occur to the items in this RecyclerViewEx.
     */
    ...
    /**
     * Gets the current ItemAnimator for this RecyclerViewEx. A null return value
     * indicates that there is no animator and that item changes will happen without
     * any animations. By default, RecyclerViewEx instantiates and
    ...
    protected ViewGroup.LayoutParams generateDefaultLayoutParams() {
        if (mLayout == null) {
            throw new IllegalStateException("RecyclerViewEx has no LayoutManager");
        }
    ...
    /**
     * Invalidates all ItemDecorations. If RecyclerViewEx has item decorations, calling this method
    ...
    /**
     * Retrieve the {@link android.support.v7.widget.RecyclerViewEx.ViewHolder} for the given child view.
     *
     * @param child Child of this RecyclerViewEx to query for its ViewHolder
    ...
    /**
     * Return the ViewHolder for the item with the given id. The RecyclerViewEx must
     * use an Adapter with {@link android.support.v7.widget.RecyclerViewEx.Adapter#setHasStableIds(boolean) stableIds} to
     ...
     * Useful for implementing simple scrolling in {@link android.support.v7.widget.RecyclerViewEx.LayoutManager LayoutManagers}.
     *
    ...
    /**
     * Called when an item view is attached to this RecyclerViewEx.
     *
     * <p>Subclasses of RecyclerViewEx may want to perform extra bookkeeping or modifications
     * of child views as they become attached. This will be called before a
     * {@link android.support.v7.widget.RecyclerViewEx.LayoutManager} measures or lays out the view and is a good time to perform these
     * changes.</p>
     *
     * @param child Child view that is now attached to this RecyclerViewEx and its associated window
     */
    public void onChildAttachedToWindow(View child) {
    }

    /**
     * Called when an item view is detached from this RecyclerViewEx.
     *
     * <p>Subclasses of RecyclerViewEx may want to perform extra bookkeeping or modifications
     * of child views as they become detached. This will be called as a
     * {@link android.support.v7.widget.RecyclerViewEx.LayoutManager} fully detaches the child view from the parent and its window.</p>
     *
     * @param child Child view that is now detached from this RecyclerViewEx and its associated window
     */
    ...
    private class ViewFlinger implements Runnable {
        ...
        public void run() {
            ...
            if (scroller.computeScrollOffset()) {
                ...
                if (ViewCompat.getOverScrollMode(RecyclerViewEx.this) !=
                ...
                if (hresult != 0 || vresult != 0) {
                    ...
                    if (mScrollListener != null) {
                        mScrollListener.onScrolled(RecyclerViewEx.this, hresult, vresult);
                    }
                }
        ...
        void postOnAnimation() {
            if (mEatRunOnAnimationRequest) {
                ...
                ViewCompat.postOnAnimation(RecyclerViewEx.this, this);
            }
        }
...
//                mDuration = mSplineDuration = getSplineFlingDuration(velocity);
    ...
    private class RecyclerViewDataObserver extends AdapterDataObserver {
        ...
        void triggerUpdateProcessor() {
            if (mPostUpdatesOnAnimation && mHasFixedSize && mIsAttached) {
                ViewCompat.postOnAnimation(RecyclerViewEx.this, mUpdateChildViewsRunnable);
            } else {
     ...
     * and use {@link RecyclerViewEx#setRecycledViewPool(android.support.v7.widget.RecyclerViewEx.RecycledViewPool)}.
     * <p>
     * RecyclerViewEx automatically creates a pool for itself if you don't provide one.
     *
     */
     ...
     *
     * <p>A "scrapped" view is a view that is still attached to its parent RecyclerViewEx but
     * that has been marked for removal or reuse.</p>
     *
     * <p>Typical use of a Recycler by a {@link android.support.v7.widget.RecyclerViewEx.LayoutManager} will be to obtain views for
    ...
    public final class Recycler {
         ...
         * {@link android.support.v7.widget.RecyclerViewEx.Adapter#onCreateViewHolder(android.view.ViewGroup, int)}.
         * <p>
         * Generally, a LayoutManager should acquire its views via {@link #getViewForPosition(int)}
         * and let the RecyclerViewEx handle caching. This is a helper method for LayoutManager who
        ...
        /**
         * RecyclerViewEx provides artificial position range (item count) in pre-layout state and
         * automatically maps these positions to {@link android.support.v7.widget.RecyclerViewEx.Adapter} positions when
         * {@link #getViewForPosition(int)} or {@link #bindViewToPosition(android.view.View, int)} is called.
         * <p>
         ...
         *                 less than {@link android.support.v7.widget.RecyclerViewEx.State#getItemCount()}.
         */
         ...
         *
         * This method should be used by {@link android.support.v7.widget.RecyclerViewEx.LayoutManager} implementations to obtain
         * views to represent data from an {@link android.support.v7.widget.RecyclerViewEx.Adapter}.
         * <p>
        ...
        View getViewForPosition(int position, boolean dryRun) {
            ...
            if (holder == null) {
                ...
                if (holder == null) {
                    holder = mAdapter.createViewHolder(RecyclerViewEx.this,
         ...
         * @see android.support.v7.widget.RecyclerViewEx.LayoutManager#removeAndRecycleView(android.view.View, android.support.v7.widget.RecyclerViewEx.Recycler)
         */
        ...
        void recycleViewHolderInternal(ViewHolder holder) {
            ...
            if (holder.isTmpDetached()) {
                throw new IllegalArgumentException("Tmp detached view should be removed "
                        + "from RecyclerViewEx before it can be recycled: " + holder);
            }
         ...
         *
         * <p>"Scrap" views are still attached to their parent RecyclerViewEx but are eligible
     ...
     * <p>
     * When {@link android.support.v7.widget.RecyclerViewEx.Recycler#getViewForPosition(int)} is called, Recycler checks attached scrap and
     * first level cache to find a matching View. If it cannot find a suitable View, Recycler will
     * call the {@link #getViewForPositionAndType(android.support.v7.widget.RecyclerViewEx.Recycler, int, int)} before checking
     * {@link android.support.v7.widget.RecyclerViewEx.RecycledViewPool}.
     * <p>
    ...
    public abstract static class ViewCacheExtension {
         ...
         * {@link android.support.v7.widget.RecyclerViewEx.LayoutManager#stopIgnoringView(android.view.View)} before returning the View.
         * <p>
         * RecyclerViewEx will re-bind the returned View to the position if necessary.
         *
         * @param recycler The Recycler that can be used to bind the View
         * @param position The adapter position
         * @param type     The type of the View, defined by adapter
         * @return A View that is bound to the given position or NULL if there is no View to re-use
         * @see android.support.v7.widget.RecyclerViewEx.LayoutManager#ignoreView(android.view.View)
         */
     ...
     * within a {@link RecyclerViewEx}.</p>
     */
    public static abstract class Adapter<VH extends ViewHolder> {
        ...
        /**
         * Called when RecyclerViewEx needs a new {@link android.support.v7.widget.RecyclerViewEx.ViewHolder} of the given type to represent
         * an item.
         * <p>
         ...
         * {@link #onBindViewHolder(android.support.v7.widget.RecyclerViewEx.ViewHolder, int)}. Since it will be re-used to display different
         ...
         * @see #onBindViewHolder(android.support.v7.widget.RecyclerViewEx.ViewHolder, int)
         */
        public abstract VH onCreateViewHolder(ViewGroup parent, int viewType);

        /**
         * Called by RecyclerViewEx to display the data at the specified position. This method
         * should update the contents of the {@link android.support.v7.widget.RecyclerViewEx.ViewHolder#itemView} to reflect the item at
         * the given position.
         * <p>
         * Note that unlike {@link android.widget.ListView}, RecyclerViewEx will not call this
         * method again if the position of the item changes in the data set unless the item itself
         * is invalidated or the new position cannot be determined. For this reason, you should only
         * use the <code>position</code> parameter while acquiring the related data item inside this
         * method and should not keep a copy of it. If you need the position of an item later on
         * (e.g. in a click listener), use {@link android.support.v7.widget.RecyclerViewEx.ViewHolder#getPosition()} which will have the
         * updated position.
         *
        ...
        /**
         * This method calls {@link #onCreateViewHolder(android.view.ViewGroup, int)} to create a new
         * {@link android.support.v7.widget.RecyclerViewEx.ViewHolder} and initializes some private fields to be used by RecyclerViewEx.
         *
         * @see #onCreateViewHolder(android.view.ViewGroup, int)
         */
        ...
        /**
         * This method internally calls {@link #onBindViewHolder(android.support.v7.widget.RecyclerViewEx.ViewHolder, int)} to update the
         * {@link android.support.v7.widget.RecyclerViewEx.ViewHolder} contents with the item at the given position and also sets up some
         * private fields to be used by RecyclerViewEx.
         *
         * @see #onBindViewHolder(android.support.v7.widget.RecyclerViewEx.ViewHolder, int)
         */
         ...
         *
         * <p>A view is recycled when a {@link android.support.v7.widget.RecyclerViewEx.LayoutManager} decides that it no longer
         * needs to be attached to its parent {@link RecyclerViewEx}. This can be because it has
         * fallen out of visibility or a set of cached views represented by views still
         * attached to the parent RecyclerViewEx. If an item view has large or expensive data
         ...
         * {@link #onViewDetachedFromWindow(android.support.v7.widget.RecyclerViewEx.ViewHolder) onViewDetachedFromWindow}
         ...
         * {@link android.support.v7.widget.RecyclerViewEx.AdapterDataObserver#onChanged()
         * "something changed"} event if more specific data is not available.</p>
         *
         * <p>Components registering observers with an adapter are responsible for
         * {@link #unregisterAdapterDataObserver(android.support.v7.widget.RecyclerViewEx.AdapterDataObserver)
         * unregistering} those observers when finished.</p>
         *
         * @param observer Observer to register
         *
         * @see #unregisterAdapterDataObserver(android.support.v7.widget.RecyclerViewEx.AdapterDataObserver)
         */
         ...
         *
         * @see #registerAdapterDataObserver(android.support.v7.widget.RecyclerViewEx.AdapterDataObserver)
         */
        ...
        /**
         * Called by RecyclerViewEx when it starts observing this Adapter.
         * <p>
         * Keep in mind that same adapter may be observed by multiple RecyclerViews.
         *
         * @param recyclerView The RecyclerViewEx instance which started observing this adapter.
         * @see #onDetachedFromRecyclerView(RecyclerViewEx)
         */
        public void onAttachedToRecyclerView(RecyclerViewEx recyclerView) {
        }

        /**
         * Called by RecyclerViewEx when it stops observing this Adapter.
         *
         * @param recyclerView The RecyclerViewEx instance which stopped observing this adapter.
         * @see #onAttachedToRecyclerView(RecyclerViewEx)
         */
        public void onDetachedFromRecyclerView(RecyclerViewEx recyclerView) {
        }
         ...
         *
         * <p><code>RecyclerViewEx</code> will attempt to synthesize visible structural change events
     ...
     * within a <code>RecyclerViewEx</code> as well as determining the policy for when to recycle
     * item views that are no longer visible to the user. By changing the <code>LayoutManager</code>
     * a <code>RecyclerViewEx</code> can be used to implement a standard vertically scrolling list,
    ...
    public static abstract class LayoutManager {
        ...
        void setRecyclerView(RecyclerViewEx recyclerView) {
        ...
        /**
         * Calls {@code RecyclerViewEx#requestLayout} on the underlying RecyclerViewEx
         */
        public void requestLayout() {
         ...
         * rules as outlined in {@link #onLayoutChildren(android.support.v7.widget.RecyclerViewEx.Recycler, android.support.v7.widget.RecyclerViewEx.State)}.
         ...
         *
         * <p>Whether item animations are enabled in a RecyclerViewEx is determined both
         * by the return value from this method and the
         * {@link RecyclerViewEx#setItemAnimator(android.support.v7.widget.RecyclerViewEx.ItemAnimator) ItemAnimator} set on the
         * RecyclerViewEx itself. If the RecyclerViewEx has a non-null ItemAnimator but this
         ...
         * the RecyclerViewEx has a non-null ItemAnimator and this method returns true,
         * then there will be two calls to {@link #onLayoutChildren(android.support.v7.widget.RecyclerViewEx.Recycler, android.support.v7.widget.RecyclerViewEx.State)} to
        ...
        /**
         * Called when this LayoutManager is both attached to a RecyclerViewEx and that RecyclerViewEx
         * is attached to a window.
         *
         * <p>Subclass implementations should always call through to the superclass implementation.
         * </p>
         *
         * @param view The RecyclerViewEx this LayoutManager is bound to
         */
        ...
        /**
         * @deprecated
         * override {@link #onDetachedFromWindow(RecyclerViewEx, android.support.v7.widget.RecyclerViewEx.Recycler)}
         */
        @Deprecated
        public void onDetachedFromWindow(RecyclerViewEx view) {

        }

        /**
         * Called when this LayoutManager is detached from its parent RecyclerViewEx or when
         * its parent RecyclerViewEx is detached from its window.
         *
         * <p>Subclass implementations should always call through to the superclass implementation.
         * </p>
         *
        ...
        /**
         * Check if the RecyclerViewEx is configured to clip child views to its padding.
         *
         * @return true if this RecyclerViewEx clips children to its padding, false otherwise
         */
         ...
         * RecyclerViewEx has a non-null {@link #getItemAnimator() ItemAnimator}, and simple
         ...
         * normal layout operation during {@link #onLayoutChildren(android.support.v7.widget.RecyclerViewEx.Recycler, android.support.v7.widget.RecyclerViewEx.State)}, the
         * RecyclerViewEx will have enough information to run those animations in a simple
         ...
         * {@link #onLayoutChildren(android.support.v7.widget.RecyclerViewEx.Recycler, android.support.v7.widget.RecyclerViewEx.State)}. Supporting predictive animations
         * means that {@link #onLayoutChildren(android.support.v7.widget.RecyclerViewEx.Recycler, android.support.v7.widget.RecyclerViewEx.State)} will be called twice;
         ...
         * appropriately. Also, {@link android.support.v7.widget.RecyclerViewEx.LayoutParams#isItemRemoved() removed} items will
         ...
         * appropriately, without regard to the actual bounds of the RecyclerViewEx. This allows
         * the animation system to know the location to which to animate these disappearing
         * views.</p>
         *
         * <p>The default LayoutManager implementations for RecyclerViewEx handle all of these
         * requirements for animations already. Clients of RecyclerViewEx can either use one
         ...
         *                         position
         * @param state            Transient state of RecyclerViewEx
         */
        ...
        /**
         * Create a default <code>LayoutParams</code> object for a child of the RecyclerViewEx.
         *
         * <p>LayoutManagers will often want to use a custom <code>LayoutParams</code> type
         * to store extra information specific to the layout. Client code should subclass
         * {@link android.support.v7.widget.RecyclerViewEx.LayoutParams} for this purpose.</p>
         *
         * <p><em>Important:</em> if you use your own custom <code>LayoutParams</code> type
         * you must also override
         * {@link #checkLayoutParams(android.support.v7.widget.RecyclerViewEx.LayoutParams)},
         ...
         * <p>To support smooth scrolling, override this method, create your {@link android.support.v7.widget.RecyclerViewEx.SmoothScroller}
         * instance and call {@link #startSmoothScroll(android.support.v7.widget.RecyclerViewEx.SmoothScroller)}.
         * </p>
         * @param recyclerView The RecyclerViewEx to which this layout manager is attached
         * @param state    Current State of RecyclerViewEx
         * @param position Scroll to this adapter position.
         */
        public void smoothScrollToPosition(RecyclerViewEx recyclerView, State state,
                int position) {
        ...
        /**
         * Returns the resolved layout direction for this RecyclerViewEx.
         *
        ...
        /**
         * Ends all animations on the view created by the {@link android.support.v7.widget.RecyclerViewEx.ItemAnimator}.
         *
         * @param view The View for which the animations should be ended.
         * @see android.support.v7.widget.RecyclerViewEx.ItemAnimator#endAnimations()
         */
        ...
        /**
         * To be called only during {@link #onLayoutChildren(android.support.v7.widget.RecyclerViewEx.Recycler, android.support.v7.widget.RecyclerViewEx.State)} to add a view
         * to the layout that is known to be going away, either because it has been
         * {@link android.support.v7.widget.RecyclerViewEx.Adapter#notifyItemRemoved(int) removed} or because it is actually not in the
         * visible portion of the container but is being laid out in order to inform RecyclerViewEx
        ...
        /**
         * Add a view to the currently attached RecyclerViewEx if needed. LayoutManagers should
         * use this method to add views obtained from a {@link android.support.v7.widget.RecyclerViewEx.Recycler} using
         * {@link android.support.v7.widget.RecyclerViewEx.Recycler#getViewForPosition(int)}.
         *
        ...
        private void addViewInt(View child, int index, boolean disappearing) {
            ...
            if (holder.wasReturnedFromScrap() || holder.isScrap()) {
                ...
                if (currentIndex == -1) {
                    throw new IllegalStateException("Added View has RecyclerViewEx as parent but"
        ...
        /**
         * Remove a view from the currently attached RecyclerViewEx if needed. LayoutManagers should
         ...
         * {@link android.support.v7.widget.RecyclerViewEx.Recycler#recycleView(android.view.View)}.
         *
        ...
        /**
         * Remove all views from the currently attached RecyclerViewEx. This will not recycle
         ...
         * child views.
         * <p>
         * If a view is ignored via {@link #ignoreView(android.view.View)}, it is also ignored by this method.
         *
         ...
         * views currently attached to the RecyclerViewEx. Generally LayoutManager implementations
         * will want to use {@link #detachAndScrapView(android.view.View, android.support.v7.widget.RecyclerViewEx.Recycler)}
         ...
         * {@link #attachView(android.view.View, int, android.support.v7.widget.RecyclerViewEx.LayoutParams) reattach}
         * or {@link #removeDetachedView(android.view.View) fully remove} the detached view
         * before the LayoutManager entry point method called by RecyclerViewEx returns.</p>
         *
         ...
         * {@link #detachAndScrapView(android.view.View, android.support.v7.widget.RecyclerViewEx.Recycler)}  scrapped}.
         *
        ...
        /**
         * Detach a child view and add it to a {@link android.support.v7.widget.RecyclerViewEx.Recycler Recycler's} scrap heap.
         *
        ...
        /**
         * Return the current number of child views attached to the parent RecyclerViewEx.
        ...
        /**
         * Return the width of the parent RecyclerViewEx
         *
        ...
        /**
         * Return the height of the parent RecyclerViewEx
         *
        ...
        /**
         * Return the left padding of the parent RecyclerViewEx
         *
        ...
        /**
         * Return the top padding of the parent RecyclerViewEx
         *
         * @return Padding in pixels
         */
        ...
        /**
         * Return the right padding of the parent RecyclerViewEx
         *
         * @return Padding in pixels
         */
        ...
        /**
         * Return the bottom padding of the parent RecyclerViewEx
         *
         * @return Padding in pixels
         */
        ...
        /**
         * Return the start padding of the parent RecyclerViewEx
         *
         * @return Padding in pixels
         */
        ...
        /**
         * Return the end padding of the parent RecyclerViewEx
         *
         * @return Padding in pixels
         */
        ...
        /**
         * Returns true if the RecyclerViewEx this LayoutManager is bound to has focus.
         *
         * @return True if the RecyclerViewEx has focus, false otherwise.
        ...
        /**
         * Returns true if the RecyclerViewEx this LayoutManager is bound to has or contains focus.
         *
         * @return true if the RecyclerViewEx has or contains focus
         ...
         *
         * @return A direct child of RecyclerViewEx which has focus or contains the focused child.
         */
        ...
        /**
         * Returns the number of items in the adapter bound to the parent RecyclerViewEx.
         * <p>
         * Note that this number is not necessarily equal to {@link android.support.v7.widget.RecyclerViewEx.State#getItemCount()}. In
         * methods where State is available, you should use {@link android.support.v7.widget.RecyclerViewEx.State#getItemCount()} instead.
         * For more details, check the documentation for {@link android.support.v7.widget.RecyclerViewEx.State#getItemCount()}.
         *
         * @return The number of items in the bound adapter
         * @see android.support.v7.widget.RecyclerViewEx.State#getItemCount()
         */
        ...
        /**
         * Offset all child views attached to the parent RecyclerViewEx by dx pixels along
         * the horizontal axis.
         *
        ...
        /**
         * Offset all child views attached to the parent RecyclerViewEx by dy pixels along
         * the vertical axis.
         *
         ...
         * recyling. Methods like {@link #removeAndRecycleAllViews(android.support.v7.widget.RecyclerViewEx.Recycler)} will ignore the child
         ...
         * {@link #stopIgnoringView(android.view.View)}.
         * <p>
         * You can call this method only if your LayoutManger is in onLayout or onScroll callback.
         *
         * @param view View to ignore.
         * @see #stopIgnoringView(android.view.View)
         */
         ...
         * call remove and invalidate RecyclerViewEx to ensure UI update.
         *
         ...
         * of the parent RecyclerViewEx and any added item decorations into account.
         *
         * <p>If the RecyclerViewEx can be scrolled in either dimension the caller may
        ...
        /**
         * Measure a child view using standard measurement policy, taking the padding
         * of the parent RecyclerViewEx, any added item decorations and the child margins
         * into account.
         *
         * <p>If the RecyclerViewEx can be scrolled in either dimension the caller may
         * pass 0 as the widthUsed or heightUsed parameters as they will be irrelevant.</p>
         ...
         * @param canScroll true if the parent RecyclerViewEx can scroll in this dimension
         *
         ...
         * any insets applied by {@link android.support.v7.widget.RecyclerViewEx.ItemDecoration ItemDecorations}.
         *
         * @param child Child view to query
        ...
        /**
         * Lay out the given child view within the RecyclerViewEx using coordinates that
         * include any current {@link android.support.v7.widget.RecyclerViewEx.ItemDecoration ItemDecorations}.
         *
         ...
         * {@link android.support.v7.widget.RecyclerViewEx.ItemDecoration ItemDecorations}.
         *
         * @param child Child to query
         * @return Child left edge with offsets applied
         * @see #getLeftDecorationWidth(android.view.View)
         */
         ...
         * @see #getTopDecorationHeight(android.view.View)
         */
         ...
         * @see #getRightDecorationWidth(android.view.View)
         */
         ...
         * @see #getBottomDecorationHeight(android.view.View)
         */
         ...
         * {@link android.view.View#measure(int, int)}, you can use this method to get decorations.
         *
         ...
         * {@link #calculateItemDecorationsForChild(android.view.View, android.graphics.Rect)} is called.
         *
         * @param child Child to query
         * @return The total height of item decorations applied to the child's top.
         * @see #getDecoratedTop(android.view.View)
         * @see #calculateItemDecorationsForChild(android.view.View, android.graphics.Rect)
         */
         ...
         * @see #getDecoratedBottom(android.view.View)
         * @see #calculateItemDecorationsForChild(android.view.View, android.graphics.Rect)
         */
         ...
         * @see #getDecoratedLeft(android.view.View)
         * @see #calculateItemDecorationsForChild(android.view.View, android.graphics.Rect)
         */
         ...
         * @see #getDecoratedRight(android.view.View)
         * @see #calculateItemDecorationsForChild(android.view.View, android.graphics.Rect)
         */
         ...
         * for the current content of the RecyclerViewEx.
         *
         ...
         * then {@link #onFocusSearchFailed(android.view.View, int, android.support.v7.widget.RecyclerViewEx.Recycler, android.support.v7.widget.RecyclerViewEx.State)}
        ...
        /**
         * Called when a child of the RecyclerViewEx wants a particular rectangle to be positioned
         ...
         * to bring the given rect into view, within the padded area of the RecyclerViewEx.</p>
         *
         ...
         */
        public boolean requestChildRectangleOnScreen(RecyclerViewEx parent, View child, Rect rect,
                boolean immediate) {
        ...
        /**
         * @deprecated Use {@link #onRequestChildFocus(RecyclerViewEx, android.support.v7.widget.RecyclerViewEx.State, android.view.View, android.view.View)}
         */
        @Deprecated
        public boolean onRequestChildFocus(RecyclerViewEx parent, View child, View focused) {
            // eat the request if we are in the middle of a scroll or layout
            return isSmoothScrolling() || parent.mRunningLayoutOrScroll;
        }

        /**
         * Called when a descendant view of the RecyclerViewEx requests focus.
         *
         ...
         *
         * @param parent  The RecyclerViewEx hosting this LayoutManager
         * @param state   Current state of RecyclerViewEx
         * @param child   Direct child of the RecyclerViewEx containing the newly focused view
         ...
         */
        public boolean onRequestChildFocus(RecyclerViewEx parent, State state, View child,
                View focused) {
            return onRequestChildFocus(parent, child, focused);
        }

        /**
         * Called if the RecyclerViewEx this LayoutManager is bound to has a different adapter set.
         ...
         *                   {@link #setAdapter(android.support.v7.widget.RecyclerViewEx.Adapter)} is called with {@code null}.
         */
        public void onAdapterChanged(Adapter oldAdapter, Adapter newAdapter) {
        }

        /**
         * Called to populate focusable views within the RecyclerViewEx.
         *
         ...
         * suppressed.</p>
         *
         * <p>The default implementation returns <code>false</code> to trigger RecyclerViewEx
         * to fall back to the default ViewGroup behavior.</p>
         *
         * @param recyclerView The RecyclerViewEx hosting this LayoutManager
         ...
         */
        public boolean onAddFocusables(RecyclerViewEx recyclerView, ArrayList<View> views,
                int direction, int focusableMode) {
            return false;
        }

        /**
         * Called when {@link android.support.v7.widget.RecyclerViewEx.Adapter#notifyDataSetChanged()} is triggered instead of giving
         ...
         * operation. This callback is only called if and only if {@link android.support.v7.widget.RecyclerViewEx.Adapter#notifyItemMoved}
         * is called.
         *
         * @param recyclerView
         * @param from
         ...
         *
         * <p>Read {@link RecyclerViewEx#computeHorizontalScrollExtent()} for details.</p>
         *
         * <p>Default implementation returns 0.</p>
         *
         * @param state Current state of RecyclerViewEx
         * @return The horizontal extent of the scrollbar's thumb
         * @see RecyclerViewEx#computeHorizontalScrollExtent()
         */
         ...
         * <p>Override this method if you want to support scroll bars.</p>
         *
         * <p>Read {@link RecyclerViewEx#computeHorizontalScrollOffset()} for details.</p>
         *
         * <p>Default implementation returns 0.</p>
         *
         * @param state Current State of RecyclerViewEx where you can find total item count
         * @return The horizontal offset of the scrollbar's thumb
         * @see RecyclerViewEx#computeHorizontalScrollOffset()
         */
         ...
         * <p>Override this method if you want to support scroll bars.</p>
         *
         * <p>Read {@link RecyclerViewEx#computeHorizontalScrollRange()} for details.</p>
         *
         * <p>Default implementation returns 0.</p>
         *
         * @param state Current State of RecyclerViewEx where you can find total item count
         * @return The total horizontal range represented by the vertical scrollbar
         * @see RecyclerViewEx#computeHorizontalScrollRange()
         */
         ...
         * <p>Override this method if you want to support scroll bars.</p>
         *
         * <p>Read {@link RecyclerViewEx#computeVerticalScrollExtent()} for details.</p>
         *
         * <p>Default implementation returns 0.</p>
         *
         * @param state Current state of RecyclerViewEx
         * @return The vertical extent of the scrollbar's thumb
         * @see RecyclerViewEx#computeVerticalScrollExtent()
         */
         ...
         * <p>Override this method if you want to support scroll bars.</p>
         *
         * <p>Read {@link RecyclerViewEx#computeVerticalScrollOffset()} for details.</p>
         *
         * <p>Default implementation returns 0.</p>
         *
         * @param state Current State of RecyclerViewEx where you can find total item count
         * @return The vertical offset of the scrollbar's thumb
         * @see RecyclerViewEx#computeVerticalScrollOffset()
         */
         ...
         * <p>Override this method if you want to support scroll bars.</p>
         *
         * <p>Read {@link RecyclerViewEx#computeVerticalScrollRange()} for details.</p>
         *
         * <p>Default implementation returns 0.</p>
         *
         * @param state Current State of RecyclerViewEx where you can find total item count
         * @return The total vertical range represented by the vertical scrollbar
         * @see RecyclerViewEx#computeVerticalScrollRange()
         */
        ...
        /**
         * Measure the attached RecyclerViewEx. Implementations must call
         ...
         * the minimum width and height properties of the host RecyclerViewEx if measured
         * as UNSPECIFIED. AT_MOST measurements will be treated as EXACTLY and the RecyclerViewEx
        ...
        /**
         * @return The host RecyclerViewEx's {@link android.view.View#getMinimumWidth()}
         */
        ...
        /**
         * @return The host RecyclerViewEx's {@link android.view.View#getMinimumHeight()}
         */
         ...
         * <p>RecyclerViewEx does NOT verify if the LayoutManager has changed between state save and
        ...
        /**
         * RecyclerViewEx calls this method to notify LayoutManager that scroll state has changed.
         *
         * @param state The new scroll state for RecyclerViewEx
         */
         ...
         * <p>
         * If you want to clean cached views as well, you should call {@link android.support.v7.widget.RecyclerViewEx.Recycler#clear()} too.
         * <p>
         * If a View is marked as "ignored", it is not removed nor recycled.
         *
         * @param recycler Recycler to use to recycle children
         * @see #removeAndRecycleView(android.view.View, android.support.v7.widget.RecyclerViewEx.Recycler)
         * @see #removeAndRecycleViewAt(int, android.support.v7.widget.RecyclerViewEx.Recycler)
         * @see #ignoreView(android.view.View)
         */
         ...
         * <p>
         * You should override
         * {@link #getRowCountForAccessibility(android.support.v7.widget.RecyclerViewEx.Recycler, android.support.v7.widget.RecyclerViewEx.State)},
         * {@link #getColumnCountForAccessibility(android.support.v7.widget.RecyclerViewEx.Recycler, android.support.v7.widget.RecyclerViewEx.State)},
         * {@link #isLayoutHierarchical(android.support.v7.widget.RecyclerViewEx.Recycler, android.support.v7.widget.RecyclerViewEx.State)} and
         * {@link #getSelectionModeForAccessibility(android.support.v7.widget.RecyclerViewEx.Recycler, android.support.v7.widget.RecyclerViewEx.State)} for
         ...
         *                 positions
         * @param state    The current state of RecyclerViewEx
         * @param info     The info that should be filled by the LayoutManager
         * @see android.view.View#onInitializeAccessibilityNodeInfo(
         *android.view.accessibility.AccessibilityNodeInfo)
         * @see #getRowCountForAccessibility(android.support.v7.widget.RecyclerViewEx.Recycler, android.support.v7.widget.RecyclerViewEx.State)
         * @see #getColumnCountForAccessibility(android.support.v7.widget.RecyclerViewEx.Recycler, android.support.v7.widget.RecyclerViewEx.State)
         * @see #isLayoutHierarchical(android.support.v7.widget.RecyclerViewEx.Recycler, android.support.v7.widget.RecyclerViewEx.State)
         * @see #getSelectionModeForAccessibility(android.support.v7.widget.RecyclerViewEx.Recycler, android.support.v7.widget.RecyclerViewEx.State)
         */
        public void onInitializeAccessibilityNodeInfo(Recycler recycler, State state,
                AccessibilityNodeInfoCompat info) {
            info.setClassName(RecyclerViewEx.class.getName());
         ...
         * @see android.widget.AbsListView#onInitializeAccessibilityNodeInfoForItem(android.view.View, int,
         * android.view.accessibility.AccessibilityNodeInfo)
         */
        ...
        /**
         * A LayoutManager can call this method to force RecyclerViewEx to run simple animations in
         * the next layout pass, even if there is not any trigger to do so. (e.g. adapter data
         * change).
         * <p>
         * Note that, calling this method will not guarantee that RecyclerViewEx will run animations
         * at all. For example, if there is not any {@link android.support.v7.widget.RecyclerViewEx.ItemAnimator} set, RecyclerViewEx will
         ...
         * {@link android.support.v4.view.accessibility.AccessibilityNodeInfoCompat.CollectionInfoCompat#SELECTION_MODE_NONE},
         * {@link android.support.v4.view.accessibility.AccessibilityNodeInfoCompat.CollectionInfoCompat#SELECTION_MODE_SINGLE} or
         * {@link android.support.v4.view.accessibility.AccessibilityNodeInfoCompat.CollectionInfoCompat#SELECTION_MODE_MULTIPLE}.
         * <p>
        ...
        /**
         * Called by AccessibilityDelegate when an action is requested from the RecyclerViewEx.
         *
         * @param recycler  The Recycler that can be used to convert view positions into adapter
         *                  positions
         * @param state     The current state of RecyclerViewEx
         ...
         * @see android.view.View#performAccessibilityAction(int, android.os.Bundle)
         */
     ...
     * views (in {@link android.support.v7.widget.RecyclerViewEx.ItemDecoration#onDraw(android.graphics.Canvas, RecyclerViewEx, android.support.v7.widget.RecyclerViewEx.State) onDraw()}
     * and after the items (in {@link android.support.v7.widget.RecyclerViewEx.ItemDecoration#onDrawOver(android.graphics.Canvas, RecyclerViewEx,
     * android.support.v7.widget.RecyclerViewEx.State)}.</p>
     */
    public static abstract class ItemDecoration {
        /**
         * Draw any appropriate decorations into the Canvas supplied to the RecyclerViewEx.
         * Any content drawn by this method will be drawn before the item views are drawn,
         * and will thus appear underneath the views.
         *
         * @param c Canvas to draw into
         * @param parent RecyclerViewEx this ItemDecoration is drawing into
         * @param state The current state of RecyclerViewEx
         */
        public void onDraw(Canvas c, RecyclerViewEx parent, State state) {
            onDraw(c, parent);
        }

        /**
         * @deprecated
         * Override {@link #onDraw(android.graphics.Canvas, RecyclerViewEx, android.support.v7.widget.RecyclerViewEx.State)}
         */
        @Deprecated
        public void onDraw(Canvas c, RecyclerViewEx parent) {
        }
         ...
         * @param state The current state of RecyclerViewEx.
         */
        public void onDrawOver(Canvas c, RecyclerViewEx parent, State state) {
            onDrawOver(c, parent);
        }

        /**
         * @deprecated
         * Override {@link #onDrawOver(android.graphics.Canvas, RecyclerViewEx, android.support.v7.widget.RecyclerViewEx.State)}
         */
        @Deprecated
        public void onDrawOver(Canvas c, RecyclerViewEx parent) {
        }


        /**
         * @deprecated
         * Use {@link #getItemOffsets(android.graphics.Rect, android.view.View, RecyclerViewEx, android.support.v7.widget.RecyclerViewEx.State)}
         */
        @Deprecated
         ...
         * @param parent  RecyclerViewEx this ItemDecoration is decorating
         * @param state   The current state of RecyclerViewEx.
         */
        public void getItemOffsets(Rect outRect, View view, RecyclerViewEx parent, State state) {
     ...
     * view hierarchy level of the RecyclerViewEx before those touch events are considered for
     * RecyclerViewEx's own scrolling behavior.
     *
     * <p>This can be useful for applications that wish to implement various forms of gestural
     * manipulation of item views within the RecyclerViewEx. OnItemTouchListeners may intercept
     * a touch interaction already in progress even if the RecyclerViewEx is already handling that
     * gesture stream itself for the purposes of scrolling.</p>
     */
    public interface OnItemTouchListener {
        /**
         * Silently observe and/or take over touch events sent to the RecyclerViewEx
         * before they are handled by either the RecyclerViewEx itself or its child views.
         *
         * <p>The onInterceptTouchEvent methods of each attached OnItemTouchListener will be run
         * in the order in which each listener was added, before any other touch processing
         * by the RecyclerViewEx itself or child views occurs.</p>
         *
         * @param e MotionEvent describing the touch event. All coordinates are in
         *          the RecyclerViewEx's coordinate system.
         * @return true if this OnItemTouchListener wishes to begin intercepting touch events, false
         *         to continue with the current behavior and continue observing future events in
         *         the gesture.
         */
        public boolean onInterceptTouchEvent(RecyclerViewEx rv, MotionEvent e);
         ...
         *          the RecyclerViewEx's coordinate system.
         */
        public void onTouchEvent(RecyclerViewEx rv, MotionEvent e);
    }

    /**
     * An OnScrollListener can be set on a RecyclerViewEx to receive messages
     * when a scrolling event has occurred on that RecyclerViewEx.
     *
    ...
    public interface OnScrollListener {
         ...
         *
         * @param recyclerView The RecyclerViewEx whose scroll state has changed.
         ...
         *
         * @param recyclerView The RecyclerViewEx which scrolled.
    ...
    /**
     * A RecyclerListener can be set on a RecyclerViewEx to receive messages whenever
     * a view is recycled.
     *
     * @see RecyclerViewEx#setRecyclerListener(android.support.v7.widget.RecyclerViewEx.RecyclerListener)
     */
    ...
    /**
     * A ViewHolder describes an item view and metadata about its place within the RecyclerViewEx.
     *
     * <p>{@link android.support.v7.widget.RecyclerViewEx.Adapter} implementations should subclass ViewHolder and add fields for caching
     * potentially expensive {@link android.view.View#findViewById(int)} results.</p>
     *
     * <p>While {@link android.support.v7.widget.RecyclerViewEx.LayoutParams} belong to the {@link android.support.v7.widget.RecyclerViewEx.LayoutManager},
     * {@link android.support.v7.widget.RecyclerViewEx.ViewHolder ViewHolders} belong to the adapter. Adapters should feel free to use
     * their own custom ViewHolder implementations to store data that makes binding view contents
     * easier. Implementations should assume that individual item views will hold strong references
     * to <code>ViewHolder</code> objects and that <code>RecyclerViewEx</code> instances may hold
    ...
    public static abstract class ViewHolder {
         ...
         * the end of the layout pass and then recycled by RecyclerViewEx if it is not added back to
         * the RecyclerViewEx.
         */
        ...
        /**
         * When LayoutManager supports animations, RecyclerViewEx tracks 3 positions for ViewHolders
         ...
         *
         * @return The the item's id if adapter has stable ids, {@link RecyclerViewEx#NO_ID}
         * otherwise
         */
     ...
     * {@link RecyclerViewEx}. Custom {@link android.support.v7.widget.RecyclerViewEx.LayoutManager layout managers} are encouraged
    ...
    /**
     * Observer base class for watching changes to an {@link android.support.v7.widget.RecyclerViewEx.Adapter}.
     * See {@link android.support.v7.widget.RecyclerViewEx.Adapter#registerAdapterDataObserver(android.support.v7.widget.RecyclerViewEx.AdapterDataObserver)}.
     */
    ...
    public static abstract class SmoothScroller {
        ...
        private int mTargetPosition = RecyclerViewEx.NO_POSITION;
         ...
         * <p>In each animation step, {@link RecyclerViewEx} will check
         * for the target view and call either
         * {@link #onTargetFound(android.view.View, android.support.v7.widget.RecyclerViewEx.State, android.support.v7.widget.RecyclerViewEx.SmoothScroller.Action)} or
         * {@link #onSeekTargetStep(int, int, android.support.v7.widget.RecyclerViewEx.State, android.support.v7.widget.RecyclerViewEx.SmoothScroller.Action)} until
         * SmoothScroller is stopped.</p>
         *
         * <p>Note that if RecyclerViewEx finds the target view, it will automatically stop the
         ...
         */
        void start(RecyclerViewEx recyclerView, LayoutManager layoutManager) {
            mRecyclerView = recyclerView;
            mLayoutManager = layoutManager;
            if (mTargetPosition == RecyclerViewEx.NO_POSITION) {
         ...
         * cancel any existing {@link android.support.v7.widget.RecyclerViewEx.SmoothScroller.Action} updated by
         * {@link #onTargetFound(android.view.View, android.support.v7.widget.RecyclerViewEx.State, android.support.v7.widget.RecyclerViewEx.SmoothScroller.Action)} or
         * {@link #onSeekTargetStep(int, int, android.support.v7.widget.RecyclerViewEx.State, android.support.v7.widget.RecyclerViewEx.SmoothScroller.Action)}.
         */
        final protected void stop() {
            ...
            onStop();
            mRecyclerView.mState.mTargetPosition = RecyclerViewEx.NO_POSITION;
            mTargetView = null;
            mTargetPosition = RecyclerViewEx.NO_POSITION;
         ...
         * {@link RecyclerViewEx#NO_POSITION} if no target view is set.
         */
        ...
        private void onAnimation(int dx, int dy) {
            if (!mRunning || mTargetPosition == RecyclerViewEx.NO_POSITION) {
                stop();
            }
            mPendingInitialRun = false;
            if (mTargetView != null) {
        ...
        /**
         * @see RecyclerViewEx#getChildPosition(android.view.View)
         */
        ...
        /**
         * @see android.support.v7.widget.RecyclerViewEx.LayoutManager#getChildCount()
         */
        public int getChildCount() {
        ...
        /**
         * @see android.support.v7.widget.RecyclerViewEx.LayoutManager#findViewByPosition(int)
         */
        public View findViewByPosition(int position) {
        ...
        /**
         * @see RecyclerViewEx#scrollToPosition(int)
         */
        ...
        /**
         * <p>RecyclerViewEx will call this method each time it scrolls until it can find the target
         * position in the layout.</p>
         * <p>SmoothScroller should check dx, dy and if scroll should be changed, update the
         * provided {@link android.support.v7.widget.RecyclerViewEx.SmoothScroller.Action} to define the next scroll.</p>
         *
         ...
         * will receive and it should update the provided {@link android.support.v7.widget.RecyclerViewEx.SmoothScroller.Action} to define the scroll
         * details towards the target view.
         * @param targetView    The view element which render the target position.
         * @param state         Transient state of RecyclerViewEx
         * @param action        Action instance that you should update to define final scroll action
         *                      towards the targetView
         * @return An {@link android.support.v7.widget.RecyclerViewEx.SmoothScroller.Action} to finalize the smooth scrolling
         */
        abstract protected void onTargetFound(View targetView, State state, Action action);

        /**
         * Holds information about a smooth scroll request by a {@link android.support.v7.widget.RecyclerViewEx.SmoothScroller}.
         */
        public static class Action {
            ...
            private void runIfNecessary(RecyclerViewEx recyclerView) {
                if (changed) {
                    validate();
    ...
    /**
     * <p>Contains useful information about the current RecyclerViewEx state like target scroll
     * position or view focus. State object can also keep arbitrary data, identified by resource
     * ids.</p>
     * <p>Often times, RecyclerViewEx components will need to pass information between each other.
     * To provide a well defined data bus between components, RecyclerViewEx passes the same State
    ...
    public static class State {
        ...
        /**
         * Returns whether RecyclerViewEx will run predictive animations in this layout pass
         * or not.
         *
         * @return true if RecyclerViewEx is calculating predictive animations to be run at the end
         *         of the layout pass.
         */
        ...
        /**
         * Returns whether RecyclerViewEx will run simple animations in this layout pass
         * or not.
         *
         * @return true if RecyclerViewEx is calculating simple animations to be run at the end of
         *         the layout pass.
         */
         ...
         * {@link RecyclerViewEx#NO_POSITION} if there is no target
         * position.
         */
        ...
        public boolean hasTargetScrollPosition() {
            return mTargetPosition != RecyclerViewEx.NO_POSITION;
        }
         ...
         * <p>
         * RecyclerViewEx listens for Adapter's notify events and calculates the effects of adapter
         * data changes on existing Views. These calculations are used to decide which animations
         * should be run.
         * <p>
         * To support predictive animations, RecyclerViewEx may rewrite or reorder Adapter changes to
         ...
         * scenes, RecyclerViewEx offsets {@link android.support.v7.widget.RecyclerViewEx.Recycler#getViewForPosition(int)} calls such that
         ...
         * <p>
         * You can get the adapter's item count via {@link android.support.v7.widget.RecyclerViewEx.LayoutManager#getItemCount()} method.
         *
         * @return The number of items currently available
         * @see android.support.v7.widget.RecyclerViewEx.LayoutManager#getItemCount()
         */
        public int getItemCount() {
            return mInPreLayout ?
    ...
    private class ItemAnimatorRestoreListener implements ItemAnimator.ItemAnimatorListener {
        ...
        public void onChangeFinished(ViewHolder item) {
             ...
             * {@link android.support.v7.widget.RecyclerViewEx.Recycler#getScrapViewForPosition(int, int, boolean)} and recycle it before
             * re-using
             */
     ...
     * ViewHolder items. The RecyclerViewEx will manage retaining these items while they
     * are being animated, but implementors must call the appropriate "Starting"
     * ({@link #dispatchRemoveStarting(android.support.v7.widget.RecyclerViewEx.ViewHolder)}, {@link #dispatchMoveStarting(android.support.v7.widget.RecyclerViewEx.ViewHolder)},
     * {@link #dispatchChangeStarting(android.support.v7.widget.RecyclerViewEx.ViewHolder, boolean)}, or
     * {@link #dispatchAddStarting(android.support.v7.widget.RecyclerViewEx.ViewHolder)})
     * and "Finished" ({@link #dispatchRemoveFinished(android.support.v7.widget.RecyclerViewEx.ViewHolder)},
     * {@link #dispatchMoveFinished(android.support.v7.widget.RecyclerViewEx.ViewHolder)},
     * {@link #dispatchChangeFinished(android.support.v7.widget.RecyclerViewEx.ViewHolder, boolean)},
     * or {@link #dispatchAddFinished(android.support.v7.widget.RecyclerViewEx.ViewHolder)}) methods when each item animation is
     * being started and ended.
     *
     * <p>By default, RecyclerViewEx uses {@link android.support.v7.widget.DefaultItemAnimator}</p>
     *
     * @see #setItemAnimator(android.support.v7.widget.RecyclerViewEx.ItemAnimator)
     */
    public static abstract class ItemAnimator {
         ...
         * {@link #animateChange(android.support.v7.widget.RecyclerViewEx.ViewHolder, android.support.v7.widget.RecyclerViewEx.ViewHolder, int, int, int, int)} implementation.
         * The value of this property is false by default.
         *
         * @see android.support.v7.widget.RecyclerViewEx.Adapter#notifyItemChanged(int)
         * @see android.support.v7.widget.RecyclerViewEx.Adapter#notifyItemRangeChanged(int, int)
         *
         ...
         * {@link #animateChange(android.support.v7.widget.RecyclerViewEx.ViewHolder, android.support.v7.widget.RecyclerViewEx.ViewHolder, int, int, int, int)} when changes occur.
         */
         ...
         * is governed by the return values from {@link #animateAdd(android.support.v7.widget.RecyclerViewEx.ViewHolder) animateAdd()},
         * {@link #animateMove(android.support.v7.widget.RecyclerViewEx.ViewHolder, int, int, int, int) animateMove()}, and
         * {@link #animateRemove(android.support.v7.widget.RecyclerViewEx.ViewHolder) animateRemove()}, which inform the
         * RecyclerViewEx that the ItemAnimator wants to be called later to start the
        ...
        /**
         * Called when an item is removed from the RecyclerViewEx. Implementors can choose
         * whether and how to animate that change, but must always call
         * {@link #dispatchRemoveFinished(android.support.v7.widget.RecyclerViewEx.ViewHolder)} when done, either
         * immediately (if no animation will occur) or after the animation actually finishes.
         * The return value indicates whether an animation has been set up and whether the
         * ItemAnimator's {@link #runPendingAnimations()} method should be called at the
         * next opportunity. This mechanism allows ItemAnimator to set up individual animations
         * as separate calls to {@link #animateAdd(android.support.v7.widget.RecyclerViewEx.ViewHolder) animateAdd()},
         * {@link #animateMove(android.support.v7.widget.RecyclerViewEx.ViewHolder, int, int, int, int) animateMove()},
         * {@link #animateRemove(android.support.v7.widget.RecyclerViewEx.ViewHolder) animateRemove()}, and
         * {@link #animateChange(android.support.v7.widget.RecyclerViewEx.ViewHolder, android.support.v7.widget.RecyclerViewEx.ViewHolder, int, int, int, int)} come in one by one,
         ...
         * RecyclerViewEx, but for which the system does not have enough information to animate
        ...
        /**
         * Called when an item is added to the RecyclerViewEx. Implementors can choose
         * whether and how to animate that change, but must always call
         * {@link #dispatchAddFinished(android.support.v7.widget.RecyclerViewEx.ViewHolder)} when done, either
         * immediately (if no animation will occur) or after the animation actually finishes.
         * The return value indicates whether an animation has been set up and whether the
         * ItemAnimator's {@link #runPendingAnimations()} method should be called at the
         * next opportunity. This mechanism allows ItemAnimator to set up individual animations
        ...
        /**
         * Called when an item is moved in the RecyclerViewEx. Implementors can choose
         * whether and how to animate that change, but must always call
         * {@link #dispatchMoveFinished(android.support.v7.widget.RecyclerViewEx.ViewHolder)} when done, either
         * immediately (if no animation will occur) or after the animation actually finishes.
         * The return value indicates whether an animation has been set up and whether the
         * ItemAnimator's {@link #runPendingAnimations()} method should be called at the
         * next opportunity. This mechanism allows ItemAnimator to set up individual animations
        ...
        /**
         * Called when an item is changed in the RecyclerViewEx, as indicated by a call to
         * {@link android.support.v7.widget.RecyclerViewEx.Adapter#notifyItemChanged(int)} or
         * {@link android.support.v7.widget.RecyclerViewEx.Adapter#notifyItemRangeChanged(int, int)}.
         * <p>
         * Implementers can choose whether and how to animate changes, but must always call
         * {@link #dispatchChangeFinished(android.support.v7.widget.RecyclerViewEx.ViewHolder, boolean)} for each non-null ViewHolder,
         ...
         *
         * @see #animateChange(android.support.v7.widget.RecyclerViewEx.ViewHolder, android.support.v7.widget.RecyclerViewEx.ViewHolder, int, int, int, int)
         * @param item The item which has been changed (this method must be called for
         * each non-null ViewHolder passed into
         * {@link #animateChange(android.support.v7.widget.RecyclerViewEx.ViewHolder, android.support.v7.widget.RecyclerViewEx.ViewHolder, int, int, int, int)}).
         ...
         * Also, appropriate dispatch methods (e.g., {@link #dispatchAddFinished(android.support.v7.widget.RecyclerViewEx.ViewHolder)}
         ...
         *
         * @see #isRunning(android.support.v7.widget.RecyclerViewEx.ItemAnimator.ItemAnimatorFinishedListener)
         */
