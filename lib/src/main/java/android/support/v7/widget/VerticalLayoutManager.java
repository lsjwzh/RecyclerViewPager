...
/**
 * A {@link RecyclerViewEx.LayoutManager} implementation which provides
 * similar functionality to {@link android.widget.ListView}.
 */
public class VerticalLayoutManager extends RecyclerViewEx.LayoutManager {
     ...
     * helps {@link VerticalLayoutManager} make those decisions.
     * Based on {@link #VERTICAL}, an implementation is lazily created in
    ...
    * */
     ...
     * By default, {@link VerticalLayoutManager} lays out 1 extra page of
    ...
    void ensureLayoutState() {
        ...
        if (mOrientationHelper == null) {
            mOrientationHelper = OrientationHelperEx.createOrientationHelper(this, VERTICAL);
        }
    }
     ...
     * <code>item[10]</code>'s bottom is 20 pixels above the RecyclerViewEx's bottom.
     * <p>
     ...
     *                 start edge of the RecyclerViewEx.
    ...
    private void updateLayoutState(int layoutDirection, int requiredSpace,
        ...
        if (layoutDirection == LayoutState.LAYOUT_END) {
            ...
            mLayoutState.mItemDirection = false ? LayoutState.ITEM_DIRECTION_HEAD
     ...
     *
     * @param recycler Recycler instance of {@link RecyclerViewEx}
     ...
     * @see #recycleViewsFromStart(RecyclerViewEx.Recycler, int)
     * @see #recycleViewsFromEnd(RecyclerViewEx.Recycler, int)
     */
     ...
     * independent from the rest of the {@link VerticalLayoutManager}
     ...
     */
    private View findReferenceChildClosestToEnd(RecyclerViewEx.State state) {
     ...
     * @return A View that can be used an an anchor View.
     */
    private View findReferenceChildClosestToStart(RecyclerViewEx.State state) {
        ...
        void log() {
            if(DEBUG) {
                Log.d(TAG, "avail:" + mAvailable + ", ind:" + mCurrentPosition + ", dir:" +
                        mItemDirection + ", offset:" + mOffset + ", layoutDir:" + -1);
            }
        }
    }
