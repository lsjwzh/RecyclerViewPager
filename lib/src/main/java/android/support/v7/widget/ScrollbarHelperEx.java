 ...
 */
class ScrollbarHelperEx {

    /**
     * @param startChild View closest to start of the list. (top or left)
     * @param endChild   View closest to end of the list (bottom or right)
     */
    static int computeScrollOffset(RecyclerViewEx.State state, OrientationHelperEx orientation,
            View startChild, View endChild, RecyclerViewEx.LayoutManager lm,
     ...
     * @param endChild   View closest to end of the list (bottom or right)
     */
    static int computeScrollExtent(RecyclerViewEx.State state, OrientationHelperEx orientation,
            View startChild, View endChild, RecyclerViewEx.LayoutManager lm,
     ...
     * @param endChild   View closest to end of the list (bottom or right)
     */
    static int computeScrollRange(RecyclerViewEx.State state, OrientationHelperEx orientation,
            View startChild, View endChild, RecyclerViewEx.LayoutManager lm,
            boolean smoothScrollbarEnabled) {
        if (lm.getChildCount() == 0 || state.getItemCount() == 0 || startChild == null ||
                endChild == null) {
